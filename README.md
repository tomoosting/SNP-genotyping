...
you will need the following programs installed on you cluster (and load via module load), locally installed, or as an executable jar file. The version mentioned are the ones I used, ands would recommend using the same or newer. This tutorial uses custom Rscript which you can find in scipts directory.
1. fastqc
2. multiqc
2. AdapterRemoval
3. BWA-kit
...
3. Overrepresented sequences. Most likely low quality reads that will be foltered out in coming stages
